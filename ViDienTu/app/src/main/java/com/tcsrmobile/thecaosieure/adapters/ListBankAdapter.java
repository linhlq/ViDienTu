...
import com.tcsrmobile.thecaosieure.utils.RemoveAccent;
...
public class ListBankAdapter extends RecyclerView.Adapter<ListBankAdapter.RecyclerViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        Picasso.with(context).load(Constant.IMAGE_CARD_URL + listBankDisplayed.get(position).getImage()).into(holder.imgBank);
